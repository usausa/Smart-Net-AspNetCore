...
{
    private const string AttributeName = "Smart.AspNetCore.CustomMethodAttribute";
    ...
    {
        var value = provider.GlobalOptions.GetValue<string>("SmartAspNetCoreGeneratorValue");
